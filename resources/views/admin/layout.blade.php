            ...
            <ul class="nav">
                    ...
                    <div class="collapse" id="categories">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.categories.index') }}"
                                >All Categories</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.categories.create') }}"
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="departments">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.departments.index') }}"
                                >All Departments</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.departments.create') }}"
                ...
                <li class="nav-item">
                    <a class="nav-link" data-toggle="collapse" href="#requisitions" aria-expanded="false"
                    ...
                    <div class="collapse" id="requisitions">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.requisitions.index') }}"
                                >All Requisitions</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.requisitions.index') }}"
                                >Create Requisition</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('admin.requisitions.index') }}"
                                >Requisitions</a></li>
                        </ul>
                    </div>
